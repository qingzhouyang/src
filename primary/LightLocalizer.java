...
public class LightLocalizer {
	...
	public static double ROTATION_SPEED = 60;	//rotation speed
	...
	public void doLocalization() {
		...
		leftMotor.rotate(convertDistance(Main.WHEEL_RADIUS,14),true);
		rightMotor.rotate(convertDistance(Main.WHEEL_RADIUS,14),false);
